...
4. **Core money tools now meet A-range product design, with controlled verification still required.** Nine Core workflows save and restore outcomes, including Purchase Planner. Purchase Planner now compares every payment option at one common future date, requires the actual expected post-promo balance, distinguishes biweekly from monthly BNPL, and saves the member's reviewed funding choice. Rent vs. Buy persists for every Core member while still mirroring into Home Buying when owned. Remaining decision-shaped Core surfaces still need review.
...
| Core money tools | 93 | A- design | Nine saved/restorable Core outcomes; explicit Paycheck, Open Enrollment, Refinance, and Purchase choices; Savings Goals-to-Life Goals handoff; corrected HSA, refinance, and purchase comparisons; Core-wide Rent vs. Buy persistence with optional guide mirroring | Credit Card Optimizer and other remaining decision-shaped surfaces need review; authenticated restoration, calculation-boundary, error, mobile, and accessibility testing remain incomplete |
